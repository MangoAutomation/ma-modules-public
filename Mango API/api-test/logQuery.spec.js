...
describe('Log file query tests', function(){
    ...
    it('Simple level query', () => {
      return client.restRequest({
          path: '/rest/latest/logging/by-filename/ma.log?level=INFO&limit(1)',
          method: 'GET'
      }).then(response => {
    ...
    it('Simple level query for less than ERROR', () => {
      return client.restRequest({
          path: '/rest/latest/logging/by-filename/ma.log?level<ERROR&limit(1)',
          method: 'GET'
      }).then(response => {
    ...
    it('Simple time query', () => {
      ...
      return client.restRequest({
          path: '/rest/latest/logging/by-filename/ma.log?time=gt=' + testContext.fiveHourAgo.toISOString() + '&limit(5)',
          method: 'GET'
      }).then(response => {
    ...
    it('Simple classname eq query', () => {
        testContext.classname = 'com.infiniteautomation.mango.rest.latest.TestingRestController';
        return client.restRequest({
            path: '/rest/latest/testing/log-error-message',
            method: 'POST',
            data: 'REST api log query test'
        }).then(()=> {
          return client.restRequest({
              path: '/rest/latest/logging/by-filename/ma.log?classname=eq=' + testContext.classname  + '&limit(5)',
              method: 'GET'
          }).then(response => {
              assert.isAtLeast(response.data.length, 1);
              for(var i=0; i<response.data.length; i++){
    ...
    it('Simple method eq query', () => {
        ...
        return client.restRequest({
          ...
          return client.restRequest({
              path: '/rest/latest/logging/by-filename/ma.log?method=eq=' + testContext.method + '&limit(5)',
              method: 'GET'
          }).then(response => {
              assert.isAtLeast(response.data.length, 1);
              for(var i=0; i<response.data.length; i++){
    ...
    it('Simple method like query', () => {
        ...
        return client.restRequest({
          ...
          return client.restRequest({
              path: '/rest/latest/logging/by-filename/ma.log?like(method,' + encodeURIComponent('logEr*') + ')&limit(5)',
              method: 'GET'
          }).then(response => {
              assert.isAtLeast(response.data.length, 1);
              for(var i=0; i<response.data.length; i++){
    ...
    it('Simple message eq query', () => {
        ...
        return client.restRequest({
            ...
            return client.restRequest({
                path: '/rest/latest/logging/by-filename/ma.log?message=eq=' + encodeURIComponent('REST api log query test') + '&limit(1)',
                method: 'GET'
            }).then(response => {
                assert.isAtLeast(response.data.length, 1);
    ...
    it('Simple message like query', () => {
        ...
        return client.restRequest({
            ...
            return client.restRequest({
                path: '/rest/latest/logging/by-filename/ma.log?like(message,' + encodeURIComponent('REST api log query*') + ')&limit(1)',
                method: 'GET'
            }).then(response => {
                assert.isAtLeast(response.data.length, 1);
                assert.equal(response.data[0].message, 'REST api log query test');
    ...
    it('Expects 403 when trying to query an existing logfile that is not log4J ', function() {
        return client.restRequest({
            path: '/rest/latest/logging/by-filename/createTables.log',
            method: 'GET'
        }).then(response => {
