...
describe('logging-rest-controller', function() {
    ...
    it('GET /rest/v1/logging/by-filename/{filename}', function() {
        const params = {
        ...
        return Promise.resolve().then(() => {
            ...
            return client.restRequest({
                method: 'GET',
                path: `/rest/v1/logging/by-filename/${params.filename}`,
            });
        }).then(response => {
            // OK
    ...
    it('GET /rest/v1/logging/files', function() {
        const params = {
    ...
    it('GET /rest/v1/logging/view/{filename}', function() {
        const params = {
        ...
        return Promise.resolve().then(() => {
            ...
            return client.restRequest({
                method: 'GET',
                path: `/rest/v1/logging/view/${params.filename}`,
                params: {
