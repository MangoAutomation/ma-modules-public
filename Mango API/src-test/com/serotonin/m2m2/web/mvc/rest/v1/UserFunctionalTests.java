    ...
    public void testGetAllAdmin() {
        ...
        try {
            MvcResult result = this.mockMvc
                    .perform(get("/v1/users").sessionAttr("sessionUser", adminUser).accept(MediaType.APPLICATION_JSON))
                    .andDo(print()).andExpect(status().isOk()).andReturn();

            List<UserModel> models = this.objectMapper.readValue(result.getResponse().getContentAsString(),
