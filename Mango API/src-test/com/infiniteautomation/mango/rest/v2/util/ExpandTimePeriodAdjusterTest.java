...
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.MILLISECONDS, i);
//            test((time) ->{
...
//        for(int i=0; i<=1000; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.SECONDS, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//        for(int i=0; i<=1000; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.MINUTES, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.HOURS, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//        for(int i=0; i<=365; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.DAYS, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//        for(int i=0; i<=100; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.WEEKS, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//        for(int i=0; i<=100; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.MONTHS, i);
//            test((time) -> {
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
...
//        for(int i=0; i<=20; i++) {
//            final int j = i == 0 ? 1 : i; //avoid div 0 with %0
//            ExpandTimePeriodAdjuster adjuster = new ExpandTimePeriodAdjuster(TimePeriods.YEARS, i);
//            test((time) ->{
//                ZonedDateTime result = (ZonedDateTime)adjuster.adjustInto(time);
