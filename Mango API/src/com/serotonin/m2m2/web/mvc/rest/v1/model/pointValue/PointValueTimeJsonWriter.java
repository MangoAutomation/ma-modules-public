...
public class PointValueTimeJsonWriter extends PointValueTimeWriter{
	...
	public void writeAllStatistics(StatisticsGenerator statisticsGenerator, DataPointVO vo) throws IOException {
		...
		this.jgen.writeNumberField(TIMESTAMP, statisticsGenerator.getPeriodStartTime());
	...
	protected void writeImageValue(DataValue value, Long imageTimestamp, long periodTimestamp, DataPointVO vo, String name) throws IOException{
		if(value == null){
	 ...
	 * @throws IOException 
	 */
	protected void writeDataValue(long timestamp, DataValue value, DataPointVO vo, String name) throws IOException {
	...
	private void writeDataValue(String name, DataValue value, long timestamp, DataPointVO vo) throws IOException{
		...
		break;
		case DataTypes.IMAGE:
			jgen.writeStringField(name, imageServletBuilder.buildAndExpand(timestamp, vo.getId()).toUri().toString());
		break;
		}
	}
