 ...
 *
 */
public class XidPointValueTimeModelDefinition extends ModelDefinition{
	
	public static final String TYPE_NAME = "XID_POINT_VALUE";
	...
	public AbstractRestModel<?> createModel() {
	    return new XidPointValueTimeModel(null, null);
	}
	...
	public boolean supportsClass(Class<?> clazz) {
		return XidPointValueTimeModel.class.equals(clazz);
	}
	...
	public Class<? extends AbstractRestModel<?>> getModelClass() {
		return XidPointValueTimeModel.class;
	}
}
