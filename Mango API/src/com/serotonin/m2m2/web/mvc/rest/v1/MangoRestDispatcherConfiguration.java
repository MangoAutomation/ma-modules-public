...
/**
 * Scan the rest packages and create a Spring Context for them Exclude the swagger classes as they
 * is in a separate context.
 *
 * @author Terry Packer
 *
 */
...
public class MangoRestDispatcherConfiguration implements WebMvcConfigurer {
    ...
    /**
     * Create a Path helper that will not URL Decode the context path and request URI but will
