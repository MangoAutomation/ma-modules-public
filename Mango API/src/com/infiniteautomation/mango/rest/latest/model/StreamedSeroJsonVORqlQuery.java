...
public class StreamedSeroJsonVORqlQuery<T extends AbstractVO, TABLE extends AbstractTableDefinition, DAO extends AbstractVoDao<T, TABLE>, SERVICE extends AbstractVOService<T, TABLE, DAO>> extends StreamedSeroJsonBasicVORqlQuery<T, TABLE, DAO, SERVICE> {
     ...
     * @param filter
     */
    public StreamedSeroJsonVORqlQuery(SERVICE service, ASTNode rql, Map<String, RQLSubSelectCondition> subSelectMap, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap, Predicate<T> filter) {
     ...
     * @param valueConverterMap - can be null
     */
    public StreamedSeroJsonVORqlQuery(SERVICE service, ASTNode rql, Map<String, RQLSubSelectCondition> subSelectMap, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap) {
