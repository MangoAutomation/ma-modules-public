 ...
 * @author Terry Packer
 */
public class StreamedVORqlQuery<T extends AbstractVO, TABLE extends AbstractTableDefinition, DAO extends AbstractVoDao<T, TABLE>, SERVICE extends AbstractVOService<T, TABLE, DAO>> extends StreamedBasicVORqlQuery<T, TABLE, DAO, SERVICE> {
     ...
     * @param filter
     */
    public StreamedVORqlQuery(SERVICE service, ASTNode rql, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap, Predicate<T> filter) {
     ...
     * @param valueConverterMap
     */
    public StreamedVORqlQuery(SERVICE service, ASTNode rql, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap) {
