 ...
 * @author Terry Packer
 */
public class StreamedVORqlQuery<T extends AbstractVO, R extends Record, TABLE extends Table<R>, DAO extends AbstractVoDao<T, R, TABLE>, SERVICE extends AbstractVOService<T, R, TABLE, DAO>> extends StreamedBasicVORqlQuery<T, R, TABLE, DAO, SERVICE> {
