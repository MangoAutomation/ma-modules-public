...
public class PointValueTimeImportStream implements BiConsumer<Consumer<XidPointValueTime>, Consumer<Throwable>>{
    ...
    private final BiConsumer<Consumer<XidPointValueTime>, Consumer<Throwable>> valueProducer;
    
    public PointValueTimeImportStream(BiConsumer<Consumer<XidPointValueTime>, Consumer<Throwable>> valueProducer) {
        this.valueProducer = valueProducer;
    }

    @Override
    public void accept(Consumer<XidPointValueTime> value, Consumer<Throwable> error) {
        this.valueProducer.accept(value, error);
    }
