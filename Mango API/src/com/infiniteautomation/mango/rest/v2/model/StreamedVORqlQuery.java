 ...
 * @author Terry Packer
 */
public class StreamedVORqlQuery<T extends AbstractVO, TABLE extends AbstractTableDefinition, DAO extends AbstractDao<T, TABLE>, SERVICE extends AbstractVOService<T, TABLE, DAO>> extends StreamedBasicVORqlQuery<T, TABLE, DAO, SERVICE> {
