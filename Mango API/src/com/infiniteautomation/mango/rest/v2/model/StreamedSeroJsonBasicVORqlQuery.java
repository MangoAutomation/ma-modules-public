...
public class StreamedSeroJsonBasicVORqlQuery <T extends AbstractBasicVO, TABLE extends AbstractBasicTableDefinition, DAO extends AbstractBasicDao<T, TABLE>, SERVICE extends AbstractBasicVOService<T, TABLE, DAO>> implements JsonStreamedArray {
     ...
     * @param filter
     */
    public StreamedSeroJsonBasicVORqlQuery(SERVICE service, ASTNode rql, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap, Predicate<T> filter) {
     ...
     * @param valueConverterMap
     */
    public StreamedSeroJsonBasicVORqlQuery(SERVICE service, ASTNode rql, Map<String, Field<?>> fieldMap, Map<String, Function<Object, Object>> valueConverterMap) {
