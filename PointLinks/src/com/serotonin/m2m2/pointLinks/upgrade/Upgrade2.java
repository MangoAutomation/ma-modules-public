...
public class Upgrade2 extends DBUpgrade {
    ...
    private final String[] mysql = new String[] {
            "ALTER TABLE pointLinks MODIFY COLUMN xid VARCHAR(100) NOT NULL;"
    };
    private final String[] h2 = new String[] {
            "ALTER TABLE pointLinks ALTER COLUMN xid VARCHAR(100) NOT NULL;"
    };
    private final String[] mssql = new String[] {
            "ALTER TABLE pointLinks ALTER COLUMN xid NVARCHAR(100) NOT NULL;"
    };
    private final String[] postgres = new String[] {
            "ALTER TABLE pointLinks ALTER COLUMN xid TYPE VARCHAR(100) NOT NULL;"
    };
}
