...
<tag:page dwr="ScheduledEventsDwr" onload="init">
  <script type="text/javascript">
    ...
    function saveScheduledEvent() {
        ...
        ScheduledEventsDwr.saveScheduledEvent(editingScheduledEvent.id, $get("xid"), $get("alias"), $get("alarmLevel"), 
            ...
            if (response.hasMessages)
                ...
                if (editingScheduledEvent.id == ${newId}) {
                    stopImageFader($("se"+ editingScheduledEvent.id +"Img"));
    ...
    function setScheduledEventImg(disabled, imgNode) {
        if (disabled)
            updateImg(imgNode, "${modulePath}/web/clock_disabled.png", "<m2m2:translate key="js.js.disabledSe" escapeDQuotes="true"/>", true);
        else
        ...
        <div class="borderDiv">
          <table width="100%">
            <tr>
              ...
              <td align="right"><tag:img src="${modulePath}/web/clock_add.png" title="scheduledEvents.addSe"
                      onclick="showScheduledEvent(${newId})" id="se${newId}Img"/></td>
            </tr>
          </table>
          <table id="scheduledEventsTable">
            <tbody id="se_TEMPLATE_" onclick="showScheduledEvent(getMangoId(this))" class="ptr" style="display:none">
              <tr>
                <td><tag:img id="se_TEMPLATE_Img" src="${modulePath}/web/clock.png" title="scheduledEvents.se"/></td>
              ...
              <td>
                <table id="activeDateTable">
                  ...
                  <tr>
                    ...
                    <td id="activeMonthData"><tag:monthOptions id="activeMonth"/></td>
              ...
              <td>
                <table id="inactiveDateTable">
                  ...
                  <tr>
                    ...
                    <td id="inactiveMonthData"><tag:monthOptions id="inactiveMonth"/></td>
