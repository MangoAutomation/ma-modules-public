...
<table>
  <tr>
    ...
    <td><jview:staticPoint xid="changeMe" disabledValue="(disabled)"/></td>
  </tr>
  <tr>
    <td align="right" style="padding-right:20px">A raw point value:</td>
    <td><jview:staticPoint xid="changeMe" raw="true"/></td>
  </tr>
  <tr>
...
<table>
  <tr>
    ...
    -->
    <td align="right" style="padding-right:20px">A point value:</td>
    <td><jview:simplePoint xid="changeMe" disabledValue="(disabled)"/></td>
  </tr>
  <tr>
    <td align="right" style="padding-right:20px">A raw point value:</td>
    <td><jview:simplePoint xid="changeMe" raw="true"/></td>
  </tr>
  <tr>
    <td align="right" style="padding-right:20px">A binary point value:</td>
    <td><jview:simplePoint xid="changeMeBinary"/></td>
  </tr>
</table>
...
<jview:chart duration="1" durationType="hours" width="800" height="300">
  <jview:chartPoint xid="changeMe1" color="#2468AC"/>
  <jview:chartPoint xid="changeMe2" color="#CA8642"/>
