...
public class EnvCanPointLocatorVO extends AbstractPointLocatorVO implements JsonSerializable {
    ...
    public void addProperties(List<TranslatableMessage> list) {
        AuditEventType.addExportCodeMessage(list, "envcands.attr", ATTRIBUTE_CODES, attributeId);
    }

    @Override
    public void addPropertyChanges(List<TranslatableMessage> list, Object o) {
        EnvCanPointLocatorVO from = (EnvCanPointLocatorVO) o;
        AuditEventType.maybeAddExportCodeChangeMessage(list, "envcands.attr", ATTRIBUTE_CODES, from.attributeId,
                attributeId);
    }
