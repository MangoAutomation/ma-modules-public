...
public class MBusPointLocatorModel extends PointLocatorModel<MBusPointLocatorVO> {
    ...
    @JsonGetter("subUnit")
    @CSVColumnGetter(order = 21, header = "subUnit")
    public int getDeviceUnit() {
        return this.data.getSubUnit();
    }

    @JsonSetter("subUnit")
    @CSVColumnSetter(order = 21, header = "subUnit")
