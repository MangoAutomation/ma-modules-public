...
describe('MBus ip data source', function() {
    ...
    function assertDataSourceAttributes(saved, local) {
        ...
        assert.strictEqual(saved.connection.host, local.connection.host);
        assert.strictEqual(saved.connection.port, local.connection.port);
