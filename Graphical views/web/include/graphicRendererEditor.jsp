    ...
    function GraphicRendererEditor() {
        ...
        this.save = function() {
            ...
            if (graphicRendererEditor.typeName == "analogGraphic")
                ...
                GraphicalViewDwr.saveBinaryGraphicComponent(graphicRendererEditor.componentId, graphicRendererEditor.zeroImage,
        ...
        this.setOneImage = function(imageId) {
            ...
            if (graphicRendererEditor.oneImage != -1 && graphicRendererEditor.currentImageSetId)
                dojo.removeClass("graphicRendererBinaryImageSetOne"+ graphicRendererEditor.oneImage, "selectedImage");
